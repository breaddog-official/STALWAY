...
namespace V_AnimationSystem {
    ...
    public static class SaveSystem {
        ...
        public static string GetCompressedString(string save) {
            return "null"; //System.Convert.ToBase64String(CLZF2.Compress(System.Text.Encoding.ASCII.GetBytes(save)));
        }
        public static string GetUnCompressedString(string save) {
            return "null"; //System.Text.Encoding.ASCII.GetString(CLZF2.Decompress(System.Convert.FromBase64String(save)));
        }
